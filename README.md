...
- Timeout configurável por porta (atualmente 300ms)
...
3. Digite o IP a ser escaneado (ex: `127.0.0.1`)
...
- O tempo de scan cresce linearmente com o tamanho do intervalo de portas, já que cada porta é testada sequencialmente com timeout de 300ms. Uma versão futura com múltiplas threads ou I/O assíncrono em lote poderia paralelizar esse processo.
